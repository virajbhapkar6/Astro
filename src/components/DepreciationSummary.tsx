...
const DepreciationSummary: Component = () => {
  ...
  return (
    ...
    <div class="mx-auto p-4 space-y-4 ">
      <div class="w-[1258px] h-[272px] rounded-lg p-4 bg-white shadow-lg">
      <div class="w-full ">
        <div class="flex justify-between items-center gap-[20px] mb-2">
          <div class="flex items-center space-x-2">

            <h1 class="text-lg font-bold">Depreciation Summary</h1>
        ...
        <div class="border border-[#C0C0C0] rounded-lg p-4 bg-white shadow-lg w-[1258px] h-[292px]">
          <h2 class="w-[1218px] h-[24px] text-lg font-bold mb-2">Depreciation Policy</h2>
        ...
        <div class="w-[1258px] h-[277px] border border-[#C0C0C0] rounded-lg p-4 bg-white shadow-lg">
          <h2 class="w-[1218px] h-[24px] text-lg font-bold mb-2">Review of Useful Life</h2>
          <UsefulLifeTable assets={usefulLifeAssets} />
          </div>
          <div class="w-[1258px] h-[352px] border border-[#C0C0C0] rounded-lg p-4 bg-white shadow-lg">
          <h2 class="w-[1218px] h-[24px] text-lg font-bold mb-2">Analytics</h2>
          <AnalyticsTable assets={analyticsAssets} total={analyticsTotal} />
          </div>
          <div class="w-[1258px] h-[528px] border border-[#C0C0C0] rounded-lg p-4  bg-white shadow-lg">
          <h2 class="w-[1218px] h-[24px] text-lg font-bold mb-2">Depreciation Allocation</h2>
          <DepreciationAllocationTable monthlyAllocations={monthlyAllocations} totalRow={allocationTotal} />
          </div>
          <div class="w-[1258px] h-[396px] border border-[#C0C0C0] rounded-lg p-4 bg-white shadow-lg">
          <h2 class="text-lg text-[#333333] font-bold ">Recalculation of Depreciation</h2>
          <h3 class="text-md text-[#333333] font-medium mb-2">Summary by Category</h3>
