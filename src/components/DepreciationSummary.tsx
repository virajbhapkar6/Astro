      ...
      <div class="w-auto h-auto border border-[#F9FAFB] rounded-lg p-4 bg-white shadow-lg">
        <div class="flex justify-between items-center mb-4">
          <div class="flex items-center space-x-2">
            ...
            <h1 class="text-xl font-bold">Depreciation Summary</h1>
          ...
          <hr class="mb-4 border-t border-[#C0C0C0]" />
          <ConclusionsTable  />
        </div>
        ...
        <div class="border border-[#C0C0C0] rounded-lg p-4 bg-white shadow-lg">
          <h2 class="text-xl font-bold py-4">Review of Useful Life</h2>
          <UsefulLifeTable assets={usefulLifeAssets} />
          </div>
          <div class="border border-[#C0C0C0] rounded-lg p-4 bg-white shadow-lg">
          <h2 class="text-xl font-bold py-4">Analytics</h2>
          <AnalyticsTable assets={analyticsAssets} total={analyticsTotal} />
          </div>
          <div class="border border-[#C0C0C0] rounded-lg p-2 bg-white shadow-lg">
          <h2 class="text-xl font-bold py-3">Depreciation Allocation</h2>
