      ...
      <table class="min-w-full divide-y divide-gray-200">
        ...
        <tbody class="bg-white divide-y divide-gray-200">
          <For each={props.monthlyAllocations}>
            {(allocation) => (
              <tr>
                <td class="px-4 py-3 whitespace-nowrap text-sm font-medium text-gray-900">{allocation.month}</td>
                <td class="px-4 py-3 whitespace-nowrap text-sm text-gray-500 text-center">{allocation.overhead}</td>
                <td class="px-4 py-3 whitespace-nowrap text-sm text-gray-500 text-center">{allocation.selling}</td>
                <td class="px-4 py-3 whitespace-nowrap text-sm text-gray-500 text-center">{allocation.gAndA}</td>
                <td class="px-4 py-3 whitespace-nowrap text-sm text-gray-500 text-center">{allocation.rAndD}</td>
                <td class="px-4 py-3 whitespace-nowrap text-sm text-gray-500 text-center">{allocation.total}</td>
                ...
                <td class="px-4 py-3 whitespace-nowrap text-sm text-gray-500 text-center">{allocation.gAndAPercent}</td>
                <td class="px-4 py-3 whitespace-nowrap text-sm text-gray-500 text-center">{allocation.rAndDPercent}</td>
              </tr>
            )}
          </For>
