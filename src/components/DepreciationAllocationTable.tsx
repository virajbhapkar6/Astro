...
const DepreciationAllocationTable: Component<DepreciationAllocationTableProps> = (props) => {
  return (
    <div class="w-[1218px] h-[445px] rounded-lg">
      <table class="min-w-full divide-y divide-gray-200 rounded-lg">
        <thead class="bg-[#F3F4F6]">
          <tr>
            <th class="w-[116px] h-[62px] border border-[#C0C0C0]   text-xs font-bold text-[#4F4F4F] " rowspan="2">
            ...
            <th
              rowspan="2"
              scope="col"
              class=" w-[116px] h-[32px] p-[4px] border border-[#C0C0C0] text-center text-xs font-medium text-[#4F4F4F] "
            >
              Total
            </th>
            <th
              scope="col"
              colspan="4"
              class="w-[494.5px] h-[31px] p-[4px] border border-[#C0C0C0] text-center text-xs font-medium text-[#4F4F4F] "
            >
          ...
          <tr class="bg-[#F3F4F6]">
            <th
              scope="col"
              class="w-[124.38px] h-[32px] flex gap-2 px-4 py-4  text-center text-xs font-medium text-[#4F4F4F] "
            >
        ...
        <tbody class="bg-[#FFFFFF] divide-y divide-gray-200">
          <For each={props.monthlyAllocations}>
            {(allocation) => (
              <tr>
                <td class="p-[4px] border border-[#C0C0C0] whitespace-nowrap text-sm text-center font-medium text-[#4F4F4F] bg-[#F3F4F6]">
                  {allocation.month}
                </td>
          ...
          <tr class="bg-[#F3F4F6] font-medium">
            <td class="p-[4px] whitespace-nowrap text-sm font-medium text-center text-[#F9FAFB] bg-[#777695]">Total</td>
