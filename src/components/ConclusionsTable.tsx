...
export default function ConclusionsTable() {
      ...
      return (
        <div class="flex justify-end">
          <svg width="53" height="22" viewBox="0 0 53 22" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <path
              d="M11.2715 15V6.27273H14.7146C15.3737 6.27273 15.9362 6.39062 16.4021 6.62642C16.8709 6.85937 17.2274 7.19034 17.4717 7.61932C17.7189 8.04545 17.8425 8.54687 17.8425 9.12358C17.8425 9.70312 17.7175 10.2017 17.4675 10.6193C17.2175 11.0341 16.8553 11.3523 16.3808 11.5739C15.9092 11.7955 15.3382 11.9062 14.6678 11.9062H12.3624V10.4233H14.3695C14.7217 10.4233 15.0144 10.375 15.2473 10.2784C15.4803 10.1818 15.6536 10.0369 15.7672 9.84375C15.8837 9.65057 15.9419 9.41051 15.9419 9.12358C15.9419 8.83381 15.8837 8.58949 15.7672 8.39062C15.6536 8.19176 15.4788 8.04119 15.2431 7.93892C15.0101 7.83381 14.7161 7.78125 14.361 7.78125H13.1166V15H11.2715ZM15.9845 11.0284L18.1536 15H16.1166L13.9945 11.0284H15.9845ZM18.8141 7.79403V6.27273H25.9817V7.79403H23.3098V15H21.486V7.79403H18.8141Z"
              fill="white"
            />
            <path
              d="M42.426 8.79375C42.8667 8.35313 42.8667 7.64063 42.426 7.20469C41.9854 6.76875 41.2729 6.76406 40.837 7.20469L35.6338 12.4078L33.4307 10.2047C32.9901 9.76406 32.2776 9.76406 31.8417 10.2047C31.4057 10.6453 31.401 11.3578 31.8417 11.7938L34.8417 14.7938C35.2823 15.2344 35.9948 15.2344 36.4307 14.7938L42.426 8.79375Z"
              fill="white"
            />
          </svg>
        </div>
  ...
  const columns = [
    {
      ...
      meta: {
        className: () =>
          "px-2 py-1.5 font-inter font-normal text-xs leading-[150%] tracking-[0%] text-[#4F4F4F] align-middle border-r border-gray-400",
      },
    },
    {
  ...
  return (
    <div class="w-[1215px] h-[165px] border border-[#C0C0C0] rounded-lg overflow-hidden shadow-lg">
