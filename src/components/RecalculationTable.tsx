      ...
      <table class="min-w-full divide-y divide-gray-200">
        ...
        <tbody class="bg-white divide-y divide-gray-200">
          <For each={props.items}>
            {(item) => (
              <tr>
                <td class="px-4 py-3 border border-[#C0C0C0] whitespace-nowrap text-sm font-medium text-gray-900">{item.category}</td>
                <td class="px-4 py-3 border border-[#C0C0C0] whitespace-nowrap text-sm text-gray-500">{item.closingBalance}</td>
                <td class="px-4 py-3 border border-[#C0C0C0] whitespace-nowrap text-sm text-gray-500 text-center">
                  {item.expectedDepreciation}
                </td>
                <td class="px-4 py-3 border border-[#C0C0C0] whitespace-nowrap text-sm text-gray-500 text-center">{item.actualDepreciation}</td>
                <td class="px-4 py-3 border border-[#C0C0C0] whitespace-nowrap text-sm text-gray-500 text-center">{item.difference}</td>
                <td class="px-4 py-3 border border-[#C0C0C0] whitespace-nowrap text-sm text-gray-500 text-center">{item.result}</td>
                <td class="px-4 py-3 border border-[#C0C0C0] whitespace-nowrap text-sm text-gray-500 text-center">
                  {item.expectedAccumulated}
                </td>
                <td class="px-4 py-3 border border-[#C0C0C0] whitespace-nowrap text-sm text-gray-500 text-center">{item.actualAccumulated}</td>
                <td class="px-4 py-3 border border-[#C0C0C0] whitespace-nowrap text-sm text-gray-500 text-center">
                  {item.differenceAccumulated}
                </td>
                <td class="px-4 py-3 border border-[#C0C0C0] whitespace-nowrap text-sm text-gray-500 text-center">{item.resultAccumulated}</td>
                <td class="px-4 py-3 border border-[#C0C0C0] whitespace-nowrap text-sm text-gray-500 text-center">
                  {item.notes && (
                    <svg
          ...
          <tr class="bg-gray-50 font-medium">
            ...
            <td class="px-4 py-3 border border-[#C0C0C0] whitespace-nowrap text-sm font-medium text-gray-900">{props.total.closingBalance}</td>
